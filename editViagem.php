    ...
    <div class="container mt-4">
        <form action="editViagem-DBUpdate.php?id_v=<?= $_GET['id_v']; ?>" method="POST">
            ...
            <div class="mb-3 row">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" id="partida" name="partida" required value="<?php echo ($viagem->partida); ?>">
                </div>
            </div>
            ...
            <div class="mb-3 row">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" id="observ" name="observ" required value="<?php echo ($viagem->observacoes); ?>">
                </div>
            </div>
