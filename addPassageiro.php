...
<body>
    ...
    <div class="container mt-4">
        <form action="addPassageiro-DBUpdate.php?id=<?= $_GET['id'];?>&destino=<?=$_GET['destino'];?>" method="POST">
            <div class="mb-3 row">
            ...
            <div class="mb-3 row">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" required id="contacto" name="contacto" placeholder="Contacto">
                </div>
            </div>
