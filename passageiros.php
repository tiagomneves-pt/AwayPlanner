...
?>
    ...
    <div class="container mt-4">
        ...
        <h5 style="color: #56445D"><?= $_GET['destino']?></h3>  
            ...
            <a class="btn btn-outline-primary btn-lg position-relative start-50" href="addPassageiro.php?id_v=<?= $_GET['id_v'];?>&destino=<?=$_GET['destino'];?>" role="button">+</a> 
    </div>
