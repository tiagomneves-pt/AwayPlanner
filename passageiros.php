            ...
            <table class="table table-hover">
                ...
                <tbody>
                    <tr>
                        ...
                        <td>
                            <div class="btn-group">
                                <a href="editPassageiro.php?id_p=<?= $passageiro->id; ?>&id_v=<?=$_GET['id'];?>&destino=<?= $_GET['destino']; ?>" class="btn btn-primary">Editar</a>
                                <a class="btn btn-danger delete-confirm" href="deletePassageiro.php?id_p=<?= $passageiro->id; ?>&id_v=<?= $_GET['id_v']; ?>" data-bs-toggle="modal" data-bs-target="#DangerModalalert">
                                    Apagar
                                </a>
                            </div>
                        </td>       
